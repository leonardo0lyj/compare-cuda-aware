...
int main(int argc, char** argv) 
{
	...
	std::cout << "GPU Allreduce Start." << std::endl;
	...
	MPI::COMM_WORLD.Allreduce(MPI_IN_PLACE, d_grad, grad_array.size(), MPI::FLOAT, MPI::SUM);
	...
	MPI::COMM_WORLD.Barrier();
	std::cout << "Total GPU Allreduce Time = " << Total_T.Stop() << " seconds. " << std::endl;
